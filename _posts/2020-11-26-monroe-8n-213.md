...
![Monore 8N-213](../public/2020-11-26/overveiw.JPG){:.shadow}
{: refdef}
...
{:refdef: style="text-align: center;"}
![Old Ad](../public/2020-11-26/add_1.JPG){:.shadow}
{: refdef}

The pricing booklet listed the cost for this machine in the 50's as $901. 

{:refdef: style="text-align: center;"}
![Price](../public/2020-11-26/cost.JPG){:.shadow}
{: refdef}
...
The 8N-213 had a 10 digit keyboard, an 10 digit counter without carry, a 11 digit counter register with carry, a 21 digit accumulator register, and a 10 digit multiplier register that could be used for back transfer from the accumulator. This calculator can perform automatic division, multiplication, and automatic squaring. 

{:refdef: style="text-align: center;"}
![Right](../public/2020-11-26/right_corner.JPG){:.shadow}
{: refdef}

{:refdef: style="text-align: center;"}
![Left](../public/2020-11-26/left.JPG){:.shadow}
{: refdef}

{:refdef: style="text-align: center;"}
![Label](../public/2020-11-26/label.JPG){:.shadow}
{: refdef}

This machine has the serial number `B745066`.

{:refdef: style="text-align: center;"}
![Serial](../public/2020-11-26/serial.JPG){:.shadow}
{: refdef}

## Register

{:refdef: style="text-align: center;"}
![Register](../public/2020-11-26/register.JPG){:.shadow}
{: refdef}
...
{:refdef: style="text-align: center;"}
![Keyboard](../public/2020-11-26/keyboard.JPG){:.shadow}
{: refdef}
...
{:refdef: style="text-align: center;"}
![Bottom buttons](../public/2020-11-26/bottom_buttons.JPG){:.shadow}
{: refdef}
...
#### Multiply by number in the accumulator multiple times
...
This was repaired by adjusting the carriage placement. Pushing on one side of the carriage and subtracting 1 would put all 9s in the accumulator. So the fault was the carriage placement. The carriage has 5 screws on the back that can loosened be used to adjust the placement.

{:refdef: style="text-align: center;"}
![Division repair](../public/2020-11-26/repair_division.JPG){:.shadow}
{: refdef}

Once loose, push the carriage the desired direction and re-tighten the screws. 

#### Multiplication constant not remaining
...
## Pictures of the machine internals

All of the outer coverings can be easily removed showing the internals of the machine and allow for servicing. 

{:refdef: style="text-align: center;"}
![Inside front](../public/2020-11-26/inside_front.JPG){:.shadow}
{: refdef}

{:refdef: style="text-align: center;"}
![Inside right](../public/2020-11-26/inside_right.JPG){:.shadow}
{: refdef}

{:refdef: style="text-align: center;"}
![Inside back](../public/2020-11-26/inside_back.JPG){:.shadow}
{: refdef}

{:refdef: style="text-align: center;"}
![Inside top](../public/2020-11-26/inside_top.JPG){:.shadow}
{: refdef}

{:refdef: style="text-align: center;"}
![Inside carriage](../public/2020-11-26/inside_carriage.JPG){:.shadow}
{: refdef}

{:refdef: style="text-align: center;"}
![Inside left](../public/2020-11-26/inside_left.JPG){:.shadow}
{: refdef}

{:refdef: style="text-align: center;"}
![Inside bottom](../public/2020-11-26/inside_bottom.JPG){:.shadow}
{: refdef}